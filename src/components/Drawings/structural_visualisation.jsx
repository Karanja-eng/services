  ...
  return (
    <div className={`w-full h-screen flex ${bgClass} ${textPrimary}`}>
      ...
      >
        {sidebarOpen && (
          <>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <button
                      ...
                      className={`w-full px-3 py-2 rounded text-left text-sm ${memberType === id
            ...
            {/* Sidebar Footer */}
            <div
              className={`p-3 border-t ${borderColor} text-xs ${textSecondary}`}
            >
      ...
      <div className="flex-1 flex flex-col relative">
        {/* Top Toolbar */}
        <div
          className={`${cardBg} border-b ${borderColor} px-4 py-2 flex items-center justify-between`}
        >
          ...
          <div className="flex items-center space-x-2">
            ...
            <button className={`p-2 rounded ${hoverBg}`} title="Zoom In">
              <ZoomIn className="w-4 h-4" />
            </button>

            <button className={`p-2 rounded ${hoverBg}`} title="Zoom Out">
        ...
        <div className="flex-1 relative" style={{ backgroundColor }}>
          ...
          <div className="absolute top-4 right-4 flex flex-col space-y-2">
            <div
              className={`${cardBg} border ${borderColor} rounded-lg shadow-lg p-2`}
            >
              ...
              <div className="mt-3 pt-2 border-t border-gray-600 flex justify-center">
                <div className="relative w-12 h-12">
                  ...
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 text-xs font-bold text-red-500">
                    N
                  </div>
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 text-xs font-bold opacity-50">
                    S
                  </div>
                  <div className="absolute right-0 top-1/2 -translate-y-1/2 text-xs font-bold opacity-50">
                    E
                  </div>
                  <div className="absolute left-0 top-1/2 -translate-y-1/2 text-xs font-bold opacity-50">
                    W
                  </div>
                </div>
              </div>
          ...
          {/* Status Bar - Bottom */}
          <div
            className={`absolute bottom-0 left-0 right-0 ${cardBg} border-t ${borderColor} px-4 py-2 flex items-center justify-between text-xs`}
          >
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className={textSecondary}>
                {showConcrete && "Concrete"} {showConcrete && showRebar && "+"}{" "}
                {showRebar && "Rebar"}
              </span>
              <span
          ...
          {measurementMode && (
            <div
              className={`absolute top-20 left-1/2 -translate-x-1/2 ${cardBg} border ${borderColor} rounded-lg shadow-lg p-4`}
            >
              ...
              <div
                className={`mt-3 pt-3 border-t ${borderColor} text-xs ${textSecondary}`}
              >
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              <section>
                ...
                <div className="space-y-2">
                  <div
                    className={`flex items-center justify-between p-2 rounded ${isDark ? "bg-green-900 bg-opacity-20" : "bg-green-50"
                      }`}
                  >
              ...
              <section>
                ...
                <textarea
                  className={`w-full p-2 text-xs rounded border ${borderColor} ${isDark ? "bg-gray-700" : "bg-white"
                    } resize-none`}
                  rows="3"
