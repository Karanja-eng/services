          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4 max-h-[calc(100vh-300px)] overflow-y-auto pr-2">
                {/* Tank Dimensions */}
                <div>
                  <h3 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-3 border-b dark:border-slate-600 pb-2">
                    Tank Dimensions
                  </h3>
                  <div className="space-y-3">
                    <InputField
                      ...
                      name="tankIntL"
                      value={formData.tankIntL}
                      onChange={handleChange}
                    />
                    <InputField
                      label="Internal Width (m)"
                      name="tankIntW"
                      value={formData.tankIntW}
                      onChange={handleChange}
                    />
                    <InputField
                      label="Internal Depth (m)"
                      name="tankDepthInt"
                      value={formData.tankDepthInt}
                      onChange={handleChange}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <InputField
                      label="Internal Length (m)"
                      name="manholeIntL"
                      value={formData.manholeIntL}
                      onChange={handleChange}
                    />
                    <InputField
                      label="Internal Width (m)"
                      name="manholeIntW"
                      value={formData.manholeIntW}
                      onChange={handleChange}
                    />
                    <InputField
                      label="Internal Depth (m)"
                      name="manholeDepthInt"
                      value={formData.manholeDepthInt}
                      onChange={handleChange}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    />
                    <InputField
                      label="Tank Bed Thickness (m)"
                      name="bedThickTank"
                      value={formData.bedThickTank}
                      onChange={handleChange}
                    />
                    <InputField
                      label="Manhole Bed Thickness (m)"
                      name="bedThickManhole"
                      value={formData.bedThickManhole}
                      onChange={handleChange}
                    />
                    <InputField
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <InputField
                      ...
                      name="numBaffles"
                      value={formData.numBaffles}
                      onChange={handleChange}
                      type="number"
                      step="1"
                    />
                    <InputField
                      label="Baffle Length (m)"
                      name="baffleL"
                      value={formData.baffleL}
                      onChange={handleChange}
                    />
                    <InputField
                      label="Baffle Thickness (m)"
                      name="baffleThick"
                      value={formData.baffleThick}
                      onChange={handleChange}
                    />
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    />
                    <InputField
                      label="Cover Soil Depth (m)"
                      name="coverSoilDepth"
                      value={formData.coverSoilDepth}
                      onChange={handleChange}
                    />
                    <InputField
                      label="Number of Covers"
                      name="numCovers"
                      value={formData.numCovers}
                      onChange={handleChange}
                      type="number"
                      step="1"
                    />
                    <InputField
                      ...
                      name="coverL"
                      value={formData.coverL}
                      onChange={handleChange}
                    />
                    <InputField
                      label="Cover Width (m)"
                      name="coverW"
                      value={formData.coverW}
                      onChange={handleChange}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <InputField
                      label="Inlet Pipe Length (m)"
                      name="inletPipeL"
                      value={formData.inletPipeL}
                      onChange={handleChange}
                    />
                    <InputField
                      label="Outlet Pipe Length (m)"
                      name="outletPipeL"
                      value={formData.outletPipeL}
                      onChange={handleChange}
                    />
                  </div>
                </div>
