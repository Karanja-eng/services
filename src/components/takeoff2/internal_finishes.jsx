...
const InternalFinishesTakeoff = () => {
  ...
  const simulateCalculation = (payload) => {
    ...
    const wallTilingFactor =
      payload.materials.wall_tiling === "full"
        ? 1.0
        : payload.materials.wall_tiling === "partial"
        ? 0.3
        : 0;
    ...
    return {
      ...
      items: [
        ...
        },
        {
          item_no: "1.1",
          description:
            "Cement sand plaster (1:4) 15mm thick to internal walls including finishing",
          unit: "m²",
        ...
        {
          item_no: "1.2",
          description: `300x300mm ceramic wall tiles ${
            wallTilingFactor > 0
              ? "to bathroom/kitchen areas"
              : "(not applicable)"
          }`,
          unit: "no.",
          quantity: Math.ceil(
            (totalWall * wallTilingFactor) / (tileSize * tileSize)
          ),
          rate: "85.00",
          amount: (
            Math.ceil((totalWall * wallTilingFactor) / (tileSize * tileSize)) *
            85
          ).toFixed(2),
        },
        {
        ...
        },
        {
          item_no: "2.1",
          description:
            payload.materials.ceiling_finish === "gypsum"
          ...
          amount: (
            totalCeiling *
            (payload.materials.ceiling_finish === "gypsum" ? 1200 : 450)
          ).toFixed(2),
        },
        {
          item_no: "2.2",
          ...
          rate: "180.00",
          amount: (totalCeiling * payload.materials.paint_coats * 180).toFixed(
            2
          ),
        },
        {
        ...
        },
        {
          ...
          rate: "95.00",
          amount: (Math.ceil(totalFloor / (tileSize * tileSize)) * 95).toFixed(
            2
          ),
        },
        {
        ...
        },
        {
          ...
          unit: "m²",
          quantity: (totalDoorArea * 2 * payload.materials.paint_coats).toFixed(
            2
          ),
          rate: "220.00",
          amount: (
        ...
        },
        {
          ...
          unit: "m²",
          quantity: (totalWindowArea * payload.materials.paint_coats).toFixed(
            2
          ),
          rate: "220.00",
          amount: (
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-800">
              Internal Finishes Quantity Takeoff
            </h1>
          </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <input
                            ...
                            onChange={(e) =>
                              updateRoom(room.id, "doorHeight", e.target.value)
                            }
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateRoom(room.id, "doorWidth", e.target.value)
                            }
                            className="w-full px-2 py-1 text-sm border border-gray-300 rounded"
                            placeholder="W: 0.9m"
                          />
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateRoom(room.id, "windowWidth", e.target.value)
                            }
                            className="w-full px-2 py-1 text-sm border border-gray-300 rounded"
                            placeholder="W: 1.5m"
                          />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMaterials({
                        ...materials,
                        plasterThickness: e.target.value,
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-gray-400"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMaterials({
                        ...materials,
                        screedThickness: e.target.value,
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-gray-400"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMaterials({ ...materials, tileSize: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-gray-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMaterials({ ...materials, paintCoats: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-gray-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setMaterials({ ...materials, wallTiling: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-gray-400"
                  >
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-100 border-b-2 border-gray-300">
                    ...
                    <th className="text-center p-3 text-sm font-semibold text-gray-700 border border-gray-300">
                      Unit
                    </th>
                    <th className="text-right p-3 text-sm font-semibold text-gray-700 border border-gray-300">
                      Quantity
                    </th>
                    <th className="text-right p-3 text-sm font-semibold text-gray-700 border border-gray-300">
                      Rate (KES)
            ...
            <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <p className="text-lg font-semibold text-gray-800">
                  {results.summary.total_floor_area.toFixed(2)} m²
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <p className="text-xs text-gray-600 mb-1">Total Wall Area</p>
                <p className="text-lg font-semibold text-gray-800">
                  {results.summary.total_wall_area.toFixed(2)} m²
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <p className="text-xs text-gray-600 mb-1">Total Ceiling Area</p>
                <p className="text-lg font-semibold text-gray-800">
                  {results.summary.total_ceiling_area.toFixed(2)} m²
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <p className="text-xs text-gray-600 mb-1">Total Perimeter</p>
                <p className="text-lg font-semibold text-gray-800">
                  {results.summary.total_perimeter.toFixed(2)} m
                </p>
              </div>
            </div>
          </div>
