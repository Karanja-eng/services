...
/**
 * Beam 3D Visualization Component
 * Handles all beam types (simply supported, cantilever, continuous, etc.)
 */
export default function Beam3DVisualization({
  inputs,
  results,
  theme = "light",
  ...
  const getBeamLabel = () => {
    ...
    return labels[beamType] || beamType;
  };
