...
export default function Slab3DVisualization({
  inputs,
  results,
  theme = "light",
  slabType = "flat",
  ...
  const getSlabLabel = () => {
    const labels = {
      flat: "Flat Slab",
      "two-way": "Two-Way Slab",
      waffle: "Waffle Slab",
      "ribbed-slab": "Ribbed Slab",
      "solid-slab": "Solid Slab",
      "one-way": "One-Way Slab",
    };
    return labels[slabType] || slabType;
  };
