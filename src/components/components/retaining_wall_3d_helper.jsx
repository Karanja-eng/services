...
export default function RetainingWall3DVisualization({
  inputs,
  results,
  theme = "light",
  wallType = "cantilever",
  ...
  const getWallLabel = () => {
    const labels = {
      ...
      gravity: "Gravity Retaining Wall",
      anchored: "Anchored Retaining Wall",
      "sheet-pile": "Sheet Pile Wall",
      "bored-pile": "Bored Pile Wall",
