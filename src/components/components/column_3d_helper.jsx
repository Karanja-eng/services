...
export default function Column3DVisualization({
  inputs,
  results,
  theme = "light",
  ...
  const getColumnLabel = () => {
    const labels = {
      ...
      circular: "Circular Column",
      "l-shaped": "L-shaped Column",
      "t-shaped": "T-shaped Column",
      "i-shaped": "I-shaped Column",
      "circular-helix": "Circular Column with Helix",
    };
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white">
                    {getColumnLabel()} - 3D Visualization
                  </h3>
