...
# FURUKAWA_PKL = str(BASE_DIR / "model" / "model_best_val_loss_var.pkl") # REMOVED FOR PERFORMANCE

detector = YOLODetector(STRUCT_MODEL, FURN_MODEL)
geometry = GeometryProcessor()
engine = EngineeringEngine()
segmentation = ArchSegmentation("", STRUCT_MODEL) # model_path is now ignored
...
async def process_pro(
    ...
    try:
        ...
        for i, file in enumerate(files):
            ...
            # 2. Structural Segmentation (Lightweight YOLO + OpenCV + PRO 5.0 Gap Closing)
