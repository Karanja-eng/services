...
#################################
# ##################Links
# Dataset from Table 3.13 with spacings and Asv/s values
table_data = {
    6: [(85, 1.183), (90, 1.118), (100, 1.006), (125, 0.805), (150, 0.671), (175, 0.575), 
        (200, 0.503), (225, 0.447), (250, 0.402), (275, 0.366), (300, 0.335)],
    8: [(85, 1.847), (90, 1.744), (100, 1.57), (125, 1.256), (150, 1.047), (175, 0.897), 
        (200, 0.785), (225, 0.698), (250, 0.628), (275, 0.571), (300, 0.523)],
    10: [(85, 2.669), (90, 2.511), (100, 2.26), (125, 1.808), (150, 1.507), (175, 1.291), 
         (200, 1.13), (225, 1.004), (250, 0.904), (275, 0.822), (300, 0.753)],
    12: [(85, 4.729), (90, 4.467), (100, 4.02), (125, 3.216), (150, 2.681), (175, 2.297), 
         (200, 2.01), (225, 1.788), (250, 1.608), (275, 1.462), (300, 1.34)],
    16: [(85, None), (90, None), (100, None), (125, 5.73), (150, 4.776), (175, 4.09), 
         (200, 3.58), (225, 3.18), (250, 2.86), (275, 2.6), (300, 2.38)]
}

# Function to get spacing given diameter and Asv/s value
def get_spacing(diameter, asv_s):
    if diameter not in table_data:
        return None
    
    min_diff = float('inf')
    closest_spacing = None
    
    for spacing, value in table_data[diameter]:
        if value is not None:
            diff = abs(value - asv_s)
            if diff < min_diff:
                min_diff = diff
                closest_spacing = spacing
